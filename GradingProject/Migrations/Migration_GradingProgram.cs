    ...
    public partial class GradingProgram : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        CandidateID = c.String(nullable: false, maxLength: 128, fixedLength: true),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.String(nullable: false, maxLength: 128, fixedLength: true),
                        Name = c.String(),
                        Phone = c.String(maxLength: 128, fixedLength: true),
                        Email = c.String(maxLength: 128, fixedLength: true),
                        Status = c.Boolean(),
                    })
                .PrimaryKey(t => t.ID);
                ...
                c => new
                    {
                        ...
                        CreateDate = c.String(maxLength: 128, fixedLength: true),
                        Status = c.Boolean(),
                    })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.CandidateID, t.ExamID, t.QuestionID, t.TestCaseID });
